...
web3 = new Web3(App.web3Provider);
  ...
  buyThisSong: function(songToBuy) {
    alert(songToBuy);
  },  
...
//    getCurrentBandMgrs(); 
    ...
    $("#submitMgr").click(function(){
      ...
      $("#submitSong").click(function(){
        ...
        alert(inputPrice);
        App.contracts.BandApp.deployed().then(function(app){
          return app.addSong(inputSong, inputPrice, {from: web3.eth.accounts[0]});
        }).catch(function(err){
          console.log(err);
          }).then(function(){
            ...
            for (i=0; i<num; i++) {
              App.contracts.BandApp.deployed().then(function(app){
                ...
                return app.songs(inum-1);
                  ...
                  var songButton = '<button onclick="App.buyThisSong(\''+song[0]+'\')">clickme</button>';
